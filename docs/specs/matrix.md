...
| [DS002-execution-and-model-strategy](specsLoader.html?spec=DS002-execution-and-model-strategy.md) | Defines LLMAgent general execution, coding-agent task-skill execution, backend selection, and authentication boundaries. |
